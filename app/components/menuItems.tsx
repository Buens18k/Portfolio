...
const MenuItems: React.FC<{ isMenuOpen: boolean; toggleMenu: () => void }> = ({ isMenuOpen, toggleMenu }) => (
  ...
  >
    ...
    <li className="mx-4 my-5 md:my-0 cursor-pointer">
      <Link href="/#skills" className="text-3xl md:text-2xl hover:drop-shadow-skill hover:underline duration-100">
        Skills
      </Link>
    </li>
    <li className="mx-4 my-5 md:my-0 cursor-pointer">
      <Link href="/#projects" className="text-3xl md:text-2xl hover:drop-shadow-skill hover:underline duration-100">
        Projects
      </Link>
    </li>
    <li className="mx-4 my-5 md:my-0 cursor-pointer">
      <Link href="/#contact" className="text-3xl md:text-2xl hover:drop-shadow-skill hover:underline duration-100">
        Contact
      </Link>
    </li>
    <li className="mx-4 my-5 md:my-0 cursor-pointer">
      <Link href="/about" className="text-3xl md:text-2xl hover:drop-shadow-skill hover:underline duration-100" target="blank">
        About
      </Link>
    </li>
    {/* <li className="mx-4 my-5 md:my-0 cursor-pointer">
